...
const Profile = () => {
    ...
    <div className="navbar">
        <div className="go-to-home" onClick={() => {navigate("/")}} >
            <img src="/src/assets/images/png/logo.png" alt="logo Image" />
            <p>AuraEvents</p>
        </div>
    </div>
    ...
    <div className="profile-card">
        ...
        <img className="cover-image" src="/src/assets/images/png/image_large_user.png" alt="Imagen de portada del perfil" />
        <img className="profile-picture" src="src/assets/images/png/img-circle.png" alt="Foto de perfil del usuario" />
        </div>
