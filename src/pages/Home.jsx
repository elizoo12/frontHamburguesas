        ...
        <div className="sectionHome">
          <div className="sectionHome_text">
            ...
            <p>
              ...
              Descubre experiencias únicas, comparte momentos con otros y
              disfruta de cada plan sin complicaciones.
            </p>
        ...
        <div className="section2">
          <div className="container_section2">
            ...
            <p>
              ...
              vivir cada evento sin complicaciones. Queremos que disfrutes más,
              te preocupes menos y hagas de cada experiencia un recuerdo
              especial.
            </p>
            ...
            <div className="advantages">
              ...
              <div className="advantage">
                ...
                <p>
                  Guarda tus favoritos, crea recordatorios personalizados y
                  nunca pierdas un evento importante en tu agenda.
                </p>
              </div>
              <div className="advantage">
        ...
        <div className="section3">
          <div className="section3_text">
            ...
            <p>
              ...
              talleres hasta festivales y quedadas locales. Guarda tus
              favoritos, filtra por lo que te interesa y disfruta de cada
              experiencia sin complicaciones. <br />
              <br />
